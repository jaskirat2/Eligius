...
### any user will go to Developer option, this interface will appear which has 5 customized buttons, each of which will take the user to my account on that particular social media platform.
